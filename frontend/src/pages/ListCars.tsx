...
export default function App() {
  ...
  return (
    <div className=" mx-auto bg-red-600 flex flex-row items-center justify-center h-screen">
      ...
      <div className="flex items-center justify-center bg-yellow-500 h-full w-full">
        <div className="flex flex-row items-center justify-center bg-green-500 h-full w-full">
          {cars.map((car) => (
            <div key={car._id}>
              <h2>
